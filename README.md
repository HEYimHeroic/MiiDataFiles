...
* RCD
   ...
   * While unknown for sure, it's assumed RCD stands for **R**evolution **C**haracter **D**ata. .mii and .miigx are literal meanings (though the "gx" in .miigx is meant to represent the name of the Wii Homebrew application that imports those files onto the console, Save Game Loader GX), while .mae stands for **M**y **A**vatar **E**ditor.
...
* CFSD
   ...
   * While unknown for sure, it's assumed CFSD stands for **C**itra **F**ace **S**tore **D**ata.
...
* FFSD
   ...
   * While unknown for sure, it's assumed FFSD stands for Ca**f**é **F**ace **S**tore **D**ata. The Wii U could not use the first letter of Café, as that would collide with the 3DS's name, which is also CFSD. So, to separate them, the Wii U uses the F in Café.
